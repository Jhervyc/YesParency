...
<head>
    ...
    <style>
        ...
        * {
        ...
        .ap2-filter-btn:hover {
            border-color: #06251b;
            color: #06251b;
        }

        .ap2-filter-btn.active {
            background: #06251b;
            color: #ffc107;
            border-color: #06251b;
            font-weight: 700;
...
<div class="dash-content">
                    ...
                    <div class="rank-main-info">
                        ...
                        <div class="rank-item-meta">
                            ...
                            <?php if (!empty($rp['my_bid_id'])): ?>
                                <span style="background:#e4f5ea; color:#1f7a3d; font-size:9.5px; font-weight:800; padding:1px 6px; border-radius:4px;">
    ...
    <div class="proc-table-panel">
        ...
        <div style="padding:18px 18px 16px 18px; border-bottom:1px solid #f0f4f2;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="proc-title-cell">
                                ...
                                <div style="font-size:11px; color:#728277; margin-top:3px; display:flex; align-items:center; gap:10px; font-weight:500;">
            ...
            <?php if ($total_pages > 1): ?>
                <div class="ap2-pagination" style="padding:14px 20px; border-top:1px solid #edf1ee; display:flex; align-items:center; justify-content:space-between;">
                    ...
                    <div class="ap2-pagination-links" style="display:flex; gap:4px;">
                        <?php if ($page > 1): ?>
                            <a href="?search=<?= urlencode($search) ?>&mode=<?= urlencode($mode_filter) ?>&status=<?= urlencode($status_filter) ?>&sort=<?= urlencode($sort) ?>&page=<?= $page - 1 ?>" class="vp-back-link" style="padding:4px 10px; font-size:11.5px;">
