...
<head>
    ...
    <link rel="stylesheet" href="../css/pages/admin-dashboard-twd-bac.css">
</head>
...
<div class="dash-content">
            ...
            <div class="sub-card">
                <div class="sub-card-head">
                    <div class="sub-card-title">
                        <i class="bi bi-bell clr-amber"></i> Notifications
                    </div>
                        ...
                        <div class="side-notif-row">
                            ...
                            <div class="side-notif-body">
                                ...
                                <div class="notif-meta-row">
                                    ...
                                    <a href="notification.php" class="proc-action-btn review review-pill">
    ...
    <div class="sad-actions">
        <a href="bid_submissions.php" class="sad-action-card">
            <div class="sad-action-icon sad-action-icon--green"><i class="bi bi-broadcast"></i></div>
            <span>Bid Opening</span>
        </a>
        <a href="notification.php" class="sad-action-card">
            <div class="sad-action-icon sad-action-icon--gold"><i class="bi bi-bell"></i></div>
        ...
        <a href="settings.php" class="sad-action-card">
            <div class="sad-action-icon sad-action-icon--teal"><i class="bi bi-gear"></i></div>
            <span>Settings</span>
        </a>
