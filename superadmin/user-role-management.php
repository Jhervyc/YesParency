...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="user-role-management.php" class="nav-item active"><i class="bi bi-person-gear"></i><span>User & Role Management</span></a>
...
<div class="topbar" id="topbar">
    <div class="topbar-left">
        ...
        <span class="topbar-title">User & Role Management</span>
    </div>
