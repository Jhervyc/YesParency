...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action_verify_bid'])) {
    ...
    $u->close();
    header("Location: procurement-view.php?id=" . $procurement_id . ($bid_filter !== 'all' ? '&bid_filter='.$bid_filter : ''));
    exit();
}
...
if (!$proc) {
    header("Location: procurement-view.php?error=not_found");
    exit();
}
...
<div class="topbar" id="topbar">
    <div class="topbar-left">
        ...
        <span class="topbar-title">Procurement > Procurement View</span>
    </div>
...
<div class="dash-content">
    ...
    <div class="pv-page-head">
        ...
        <a href="procurement.php" class="pv-back-btn">
    ...
    <div class="pv-card">
        ...
        <div style="padding:12px 20px 0; display:flex; gap:8px; flex-wrap:wrap; border-bottom:1px solid #eaeeec; margin-bottom:0;">
            ...
            ?>
                <a href="procurement-view.php?id=<?= $procurement_id ?>&bid_filter=<?= $val ?>"
