<?php
/**
 * Global Sidebar Component for Super Admin
...
$is_users_active         = in_array($active, ['user-role-management.php', 'user-role-management']);
$is_settings_active      = in_array($active, ['settings.php', 'settings']);
$is_audit_active         = in_array($active, ['audit_trail.php', 'audit_trail']);
$admin_username          = htmlspecialchars($_SESSION['username'] ?? 'Super Admin');
?>
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="user-role-management.php" class="nav-item <?= $is_users_active ? 'active' : '' ?>">
